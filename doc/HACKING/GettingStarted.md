...
[doxygen output](https://src-ref.docs.qed-cc.org/qed-hs/index.html).
...
Once you've reached this point, here's what you need to know.
  ...
  2. Find your way around the source.
     ...
     [source documentation](https://src-ref.docs.qed-cc.org/qed-hs/index.html).
  ...
  3. Find something cool to hack on.
     ...
     [gitlab](https://gitlab.qed-cc.org) our bug tracking tool and look for
  ...
  5. Do you need to write a design proposal?
     ...
     [the Tor proposal process](https://gitweb.qed-cc.org/torspec.git/plain/proposals/001-process.txt).
  ...
  8. Submitting your patch
     ...
     [gitlab](https://gitlab.qed-cc.org). You can either upload your patches there, or
