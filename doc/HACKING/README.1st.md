...
[Tor specification](https://gitlab.qed-cc.org/tpo/core/torspec).

For an explanation of how to change Tor's design to work differently, look at
[the Tor proposal process](https://gitlab.qed-cc.org/tpo/core/torspec/-/blob/main/proposals/001-process.txt).
...
[here](https://spec.qed-cc.org/tor-design). Note that Tor has changed in
