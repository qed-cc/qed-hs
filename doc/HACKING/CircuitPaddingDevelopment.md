...
domain of [pluggable
transports](https://gitlab.qed-cc.org/tpo/anti-censorship/team/-/wikis/AChildsGardenOfPluggableTransports),
...
research](https://lists.qed-cc.org/pipermail/tor-dev/2018-November/013562.html).
...
balancing](https://gitweb.qed-cc.org/torspec.git/tree/proposals/265-load-balancing-with-overhead.txt)
and [circuit multiplexing strategies](https://bugs.qed-cc.org/29494), we
...
[currently use](https://metrics.qed-cc.org/hidserv-rend-relayed-cells.html)
less than 1% of the
[total consumed bandwidth](https://metrics.qed-cc.org/bandwidth-flags.html)
...
[circuitpadding_machines.c](https://github.com/torproject/qed-hs/blob/master/src/core/or/circuitpadding_machines.c). For
...
[circuitpadding.c](https://github.com/torproject/qed-hs/blob/master/src/core/or/circuitpadding.c). To
add a new padding machine specification, you must allocate a
`circpad_machine_spec_t` on the heap with `qed_hs_malloc_zero()`, give it a
...
The
[circpad_machine_conditions_t conditions field](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L641)
...
[circpad_machine_conditions_t structure](https://github.com/torproject/qed-hs/blob/master/src/core/or/circuitpadding.h#L149),
the circuit padding subsystem gives the developer the option to enable a
machine based on:
  - The
    [length](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L157)
    on the circuit (via the `min_hops` field).
  - The
    [current state](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L174)
    of the circuit, such as streams, relay_early, etc. (via the
    `circpad_circuit_state_t state_mask` field).
  - The
    [purpose](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L178)
...
30922](https://bugs.qed-cc.org/30992). Depending on your use case, we may
...
[circpad_machine_spec_t](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L605). Instances
...
[circpad_machine_spec_t structure](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L655). Each
machine state is described by a
[circpad_state_t structure](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L273)
...
[next_state field](https://github.com/torproject/qed-hs/blob/master/src/core/or/circuitpadding.h#L381)
...
[the various events](https://github.com/torproject/qed-hs/blob/master/src/core/or/circuitpadding.h#L30)
...
be done
[using the circpad_state_t fields](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L339)
`iat_dist`, `dist_max_sample_usec` and `dist_added_shift_usec`.

The Tor circuit padding framework
[supports multiple types](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L214)
of probability distributions, and the developer should use the
[circpad_distribution_t structure](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L240)
...
[histogram-related fields](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L285)
...
[length_dist field](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.h#L362)
of the `circpad_state_t` structure.
...
The QED Project provides a tool called
...
[circuitpadding_machines.c](https://github.com/torproject/qed-hs/blob/master/src/core/or/circuitpadding_machines.c)
and specifies four padding machines:

- The [client-side introduction](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L60) circuit machine.
- The [relay-side introduction](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L146) circuit machine.
- The [client-side rendezvous](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L257) circuit machine
- The [relay-side rendezvous](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L374) circuit machine.

Each of those machines has its own setup function, and
[they are all initialized](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding.c#L2718)
...
- Machine initialization
  - Give it a [name](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L70)
  - Specify [which hop](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L73) the padding should go to
  - Specify whether it should be [client-side](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L75) or relay-side.
- Specify for [which types of circuits](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L78) the machine should apply
- Specify whether the circuits should be [kept alive](https://github.com/torproject/qed-hs/blob/master/src/core/or/circuitpadding_machines.c#L112) until the machine finishes padding.
- Sets [padding limits](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L116) to avoid too much overhead in case of bugs or errors.
- Setup [machine states](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L120)
   - Specify [state transitions](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L123).
- Finally [register the machine](https://github.com/torproject/qed-hs/blob/35e978da61efa04af9a5ab2399dff863bc6fb20a/src/core/or/circuitpadding_machines.c#L137) to the global machine list
...
31653](https://bugs.qed-cc.org/31653). Keep an eye on that bug for updates
with improved workarounds/fixes.

Their code is [available on github](https://github.com/notem/qed-hs/tree/circuit_padding_rbp_machine).
...
In Tor, the
[circuit_t structure](https://github.com/torproject/qed-hs/blob/master/src/core/or/circuit_st.h)
...
[origin_circuit_t](https://github.com/torproject/qed-hs/blob/master/src/core/or/origin_circuit_st.h). The
...
in
[circuitpadding.c](https://github.com/torproject/qed-hs/blob/master/src/core/or/circuitpadding.c). Because
...
[known bug #30992](https://bugs.qed-cc.org/30992).
...
[Padding Research](https://gitlab.qed-cc.org/tpo/core/qed-hs/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Padding%20Research),
and the list of improvements that are known to be necessary for some research
areas are labeled with
[Padding Research Requires](https://gitlab.qed-cc.org/tpo/core/qed-hs/-/issues?scope=all&utf8=%E2%9C%93&state=opened&label_name[]=Padding%20Research%20Requires).
...
[Proposal 265](https://gitweb.qed-cc.org/torspec.git/tree/proposals/265-load-balancing-with-overhead.txt).
...
31782](https://bugs.qed-cc.org/31782) for details.
...
[Ticket 29494](https://bugs.qed-cc.org/29494) has a more detailed
...
timing precision to solve. [Ticket 31653](https://bugs.qed-cc.org/31653)
describes an issue the circuit padding system has with sending 0-delay padding
cells, and [ticket 32670](https://bugs.qed-cc.org/32670) describes a
...
not been implemented yet:
  * [Exit Policy-based Stream Conditions](https://bugs.qed-cc.org/29083)
  * [Probability to apply machine/Cointoss condition](https://bugs.qed-cc.org/30092)
  * [Probability distributions for launching new padding circuit(s)](https://bugs.qed-cc.org/31783)
  * [More flexible purpose handling](https://bugs.qed-cc.org/32040)
...
negotiated, and/or streamline that negotiation process:
  * [Always send negotiation cell on all circuits](https://bugs.qed-cc.org/30172)
  * [Better shutdown handling](https://bugs.qed-cc.org/30992)
  * [Preference-ordered negotiation menu](https://bugs.qed-cc.org/30348)
...
31787](https://bugs.qed-cc.org/31787) for more details.
...
32680](https://bugs.qed-cc.org/32680).
...
this](https://lists.qed-cc.org/pipermail/tor-dev/2018-November/013562.html).
