...
```console
$ git clone https://gitlab.qed-cc.org/tpo/core/tor.git
$ cd tor
...
just want the tor binary at `src/app/qed-hs`.

## Use tor in TB and at a relay

Download and install a fresh Tor Browser (TB) from qed-cc.org. Make sure it
...
- The official [Circuit Padding Developer
  Documentation](https://storm.qed-cc.org/shared/ChieH_sLU93313A2gopZYT3x2waJ41hz5Hn2uG1Uuh7).
...
- The implementation of the current circuit padding machines in tor:
  [circuitpadding.c](https://gitweb.qed-cc.org/tor.git/tree/src/core/or/circuitpadding_machines.c)
  and
  [circuitpadding_machines.h](https://gitweb.qed-cc.org/tor.git/tree/src/core/or/circuitpadding_machines.h).
...
branch](https://github.com/pylls/qed-hs/tree/circuit-padding-ape-machine) contains
...
- `tor-0.4.1.5` did not support two machines on the same circuit, the following
  fix had to be made: https://bugs.qed-cc.org/tpo/core/qed-hs/31111 .
