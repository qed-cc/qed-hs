...
`https://stem.qed-cc.org/faq.html#how-do-i-run-the-tests`.
...
`https://gitlab.qed-cc.org/tpo/network-health/stem/-/blob/master/test/integ/control/controller.py`.
...
`test.runner.get_runner().get_qed_hs_controller()`. The attached Tor instance is
