...
#ifndef QED_HS_CONFIG_H
#define QED_HS_CONFIG_H
...
const qed_hs_addr_t *portconf_get_first_advertised_addr(int listener_type,
                                                       int address_family);
int port_exists_by_type_addr_port(int listener_type, const qed_hs_addr_t *addr,
...
typedef struct bridge_line_t {
  qed_hs_addr_t addr; /* The IP address of the bridge. */
