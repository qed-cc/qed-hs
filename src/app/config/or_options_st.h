...
#ifndef QED_HS_OR_OPTIONS_ST_H
#define QED_HS_OR_OPTIONS_ST_H
...
struct or_options_t {
   ...
   * [][0] is IPv4, [][1] is IPv6
   */
  qed_hs_addr_t OutboundBindAddresses[OUTBOUND_ADDR_MAX][2];
  ...
  dirinfo_type_t PublishServerDescripqed_hs_;
  ...
  qed_hs_addr_t HTTPProxyAddr; /**< Parsed IPv4 addr for http proxy, if any. */
  uint16_t HTTPProxyPort; /**< Parsed port for http proxy, if any. */
  char *HTTPProxyAuthenticator; /**< username:password string, if any. */

  char *HTTPSProxy; /**< hostname[:port] to use as https proxy, if any. */
  qed_hs_addr_t HTTPSProxyAddr; /**< Parsed addr for https proxy, if any. */
  uint16_t HTTPSProxyPort; /**< Parsed port for https proxy, if any. */
  char *HTTPSProxyAuthenticator; /**< username:password string, if any. */

  char *Socks4Proxy; /**< hostname:port to use as a SOCKS4 proxy, if any. */
  qed_hs_addr_t Socks4ProxyAddr; /**< Derived from Socks4Proxy. */
  uint16_t Socks4ProxyPort; /**< Derived from Socks4Proxy. */

  char *Socks5Proxy; /**< hostname:port to use as a SOCKS5 proxy, if any. */
  qed_hs_addr_t Socks5ProxyAddr; /**< Derived from Sock5Proxy. */
  ...
  qed_hs_addr_t TCPProxyAddr; /**< Derived from TCPProxy. */
...
#endif /* !defined(QED_HS_OR_OPTIONS_ST_H) */
