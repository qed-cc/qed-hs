...
#ifndef QED_HS_CONFIG_RESOLVE_ADDR_H
#define QED_HS_CONFIG_RESOLVE_ADDR_H
...
bool find_my_address(const or_options_t *options, int family,
                     int warn_severity, qed_hs_addr_t *addr_out,
                     resolved_addr_method_t *method_out, char **hostname_out);

void resolved_addr_get_last(int family, qed_hs_addr_t *addr_out);
void resolved_addr_reset_last(int family);
void resolved_addr_set_last(const qed_hs_addr_t *addr,
                            const resolved_addr_method_t method_used,
                            const char *hostname_used);

void resolved_addr_get_suggested(int family, qed_hs_addr_t *addr_out);
void resolved_addr_set_suggested(const qed_hs_addr_t *addr);

bool resolved_addr_is_configured(int family);

MOCK_DECL(bool, is_local_to_resolve_addr, (const qed_hs_addr_t *addr));
...
#endif /* !defined(QED_HS_CONFIG_RESOLVE_ADDR_H) */
