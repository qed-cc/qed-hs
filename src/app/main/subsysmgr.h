...
#ifndef QED_HS_SUBSYSMGR_T
#define QED_HS_SUBSYSMGR_T

#include "lib/subsys/subsys.h"

extern const struct subsys_fns_t *qed_hs_subsystems[];
extern const unsigned n_qed_hs_subsystems;
...
#endif /* !defined(QED_HS_SUBSYSMGR_T) */
