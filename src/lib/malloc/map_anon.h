...
#ifndef QED_HS_MAP_ANON_H
#define QED_HS_MAP_ANON_H
...
void *qed_hs_mmap_anonymous(size_t sz, unsigned flags,
                         inherit_res_t *inherit_result_out);
void qed_hs_munmap_anonymous(void *mapping, size_t sz);

#endif /* !defined(QED_HS_MAP_ANON_H) */
