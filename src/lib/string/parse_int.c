 ...
 */
long
qed_hs_parse_long(const char *s, int base, long min, long max,
               int *ok, char **next)
{
  char *endptr;
  long r;
...
/** As qed_hs_parse_long(), but return an unsigned long. */
unsigned long
qed_hs_parse_ulong(const char *s, int base, unsigned long min,
...
/** As qed_hs_parse_long(), but return a double. */
double
qed_hs_parse_double(const char *s, double min, double max, int *ok, char **next)
{
  char *endptr;
  double r;
...
/** As qed_hs_parse_long, but return a uint64_t.  Only base 10 is guaranteed to
 * work for now. */
uint64_t
qed_hs_parse_uint64(const char *s, int base, uint64_t min,
