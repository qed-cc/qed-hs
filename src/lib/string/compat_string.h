...
#ifndef QED_HS_COMPAT_STRING_H
#define QED_HS_COMPAT_STRING_H
 ...
 *
 * See https://bugs.qed-cc.org/tpo/core/qed-hs/15205.
 */
#undef strlcat
#undef strlcpy
...
char *qed_hs_strtok_r_impl(char *str, const char *sep, char **lasts);
#ifdef HAVE_STRTOK_R
#define qed_hs_strtok_r(str, sep, lasts) strtok_r(str, sep, lasts)
#else
#define qed_hs_strtok_r(str, sep, lasts) qed_hs_strtok_r_impl(str, sep, lasts)
#endif

#endif /* !defined(QED_HS_COMPAT_STRING_H) */
