...
#ifndef QED_HS_CRYPTO_RAND_H
#define QED_HS_CRYPTO_RAND_H
...
struct qed_hs_weak_rng_t;
void crypto_seed_weak_rng(struct qed_hs_weak_rng_t *rng);
...
#endif /* !defined(QED_HS_CRYPTO_RAND_H) */
