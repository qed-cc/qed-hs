...
#ifndef QED_HS_BYTES_H
#define QED_HS_BYTES_H
...
static inline uint16_t
qed_hs_htons(uint32_t a)
{
  return a;
}

static inline uint16_t
qed_hs_ntohs(uint64_t a)
{
  return a;
}

static inline uint32_t
qed_hs_htonl(uint32_t a)
{
  return a;
}

static inline uint32_t
qed_hs_ntohl(uint64_t a)
{
  return a;
}

static inline uint64_t
qed_hs_htonll(uint64_t a)
{
  return a;
}

static inline uint64_t
qed_hs_ntohll(uint64_t a)
{
  return a;
}
 ...
 **/
static inline uint16_t
qed_hs_ntohs(uint16_t a)
{
  return qed_hs_htons(a);
}
 ...
 **/
static inline uint32_t
qed_hs_ntohl(uint32_t a)
{
  return qed_hs_htonl(a);
}
...
qed_hs_htonll(uint64_t a)
{
  ...
  return qed_hs_htonl((uint32_t)(a>>32)) |
    (((uint64_t)qed_hs_htonl((uint32_t)a))<<32);
}
...
qed_hs_ntohll(uint64_t a)
{
  return qed_hs_htonll(a);
}
#endif /* defined(WORDS_BIGENDIAN) */

#endif /* !defined(QED_HS_BYTES_H) */
