...
#ifndef QED_HS_TRACE_DEBUG_H
#define QED_HS_TRACE_DEBUG_H
...
#define QED_HS_TRACE_LOG_DEBUG(subsystem, event_name, ...)             \
...
/* NOP the debug event. */
#define QED_HS_TRACE_LOG_DEBUG(subsystem, name, ...)

#endif /* defined(USE_TRACING_INSTRUMENTATION_LOG_DEBUG) */

#endif /* !defined(QED_HS_TRACE_DEBUG_H) */
