...
#ifndef QED_HS_LIB_METRICS_METRICS_COMMON_H
#define QED_HS_LIB_METRICS_METRICS_COMMON_H
...
#define METRICS_NAME(name) METRICS_STR(qed_hs_ ## name)
...
#endif /* !defined(QED_HS_LIB_METRICS_METRICS_COMMON_H) */
