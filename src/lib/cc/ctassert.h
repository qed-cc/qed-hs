/* Copyright (c) 2018 The QED Project, Inc. */
...
#ifndef QED_HS_CTASSERT_H
#define QED_HS_CTASSERT_H
...
#define CTASSERT_DECL(x, a, b) \
  typedef char qed_hs_ctassert_##a##_##b[(x) ? 1 : -1] ATTR_UNUSED; EAT_SEMICOLON

#endif /* __STDC_VERSION__ >= 201112L */

#endif /* !defined(QED_HS_CTASSERT_H) */
