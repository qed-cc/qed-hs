 ...
 *
 * Each Tor source file is built twice: once with QED_HS_UNIT_TESTS defined, and
...
#ifndef QED_HS_TESTSUPPORT_H
#define QED_HS_TESTSUPPORT_H
...
#endif /* !defined(QED_HS_TESTSUPPORT_H) */
