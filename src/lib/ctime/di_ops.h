...
#ifndef QED_HS_DI_OPS_H
#define QED_HS_DI_OPS_H

#include "orconfig.h"
#include "lib/cc/torint.h"

int qed_hs_memcmp(const void *a, const void *b, size_t sz);
int qed_hs_memeq(const void *a, const void *b, size_t sz);
...
#define qed_hs_memneq(a,b,sz) (!qed_hs_memeq((a),(b),(sz)))
