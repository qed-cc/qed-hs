...
#ifndef QED_HS_PUBSUB_BUILD_H
#define QED_HS_PUBSUB_BUILD_H
 ...
 * initialization.
 */
struct pubsub_connecqed_hs_t *pubsub_connecqed_hs_for_subsystem(pubsub_builder_t *,
                                                          subsys_id_t);

/**
 * The main-init code does this after subsystem initialization.
 */
#define pubsub_connecqed_hs_free(c) \
  FREE_AND_NULL(struct pubsub_connecqed_hs_t, pubsub_connecqed_hs_free_, (c))

void pubsub_connecqed_hs_free_(struct pubsub_connecqed_hs_t *);
...
#endif /* !defined(QED_HS_PUBSUB_BUILD_H) */
