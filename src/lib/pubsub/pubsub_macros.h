 ...
 *
 *     static void bind_to_dispatcher(pubsub_connecqed_hs_t *con)
 *     {
 ...
 *        if (d.u64)
 *            return qed_hs_strdup("true");
 *        else
 *            return qed_hs_strdup("false");
 *    }
 *
...
#ifndef QED_HS_DISPATCH_MSG_H
#define QED_HS_DISPATCH_MSG_H
...
#endif /* !defined(QED_HS_DISPATCH_MSG_H) */
