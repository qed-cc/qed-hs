...
#ifndef QED_HS_PUBSUB_CONNECT_H
#define QED_HS_PUBSUB_CONNECT_H
 ...
 **/
typedef struct pubsub_connecqed_hs_t pubsub_connecqed_hs_t;

int pubsub_add_pub_(struct pubsub_connecqed_hs_t *con,
...
int pubsub_add_sub_(struct pubsub_connecqed_hs_t *con,
                    recv_fn_t recv_fn,
                    channel_id_t channel,
                    message_id_t msg,
                    msg_type_id_t type,
...
int pubsub_connecqed_hs_register_type_(struct pubsub_connecqed_hs_t *,
                                    msg_type_id_t,
                                    dispatch_typefns_t *,
                                    const char *file,
                                    unsigned line);

#endif /* !defined(QED_HS_PUBSUB_CONNECT_H) */
