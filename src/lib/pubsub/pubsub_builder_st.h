...
#ifndef QED_HS_PUBSUB_BUILDER_ST_H
#define QED_HS_PUBSUB_BUILDER_ST_H
...
struct pubsub_builder_t {
  /** Number of outstanding pubsub_connecqed_hs_t objects pointing to this
   * pubsub_builder_t. */
  int n_connectors;
...
#endif /* !defined(QED_HS_PUBSUB_BUILDER_ST_H) */
