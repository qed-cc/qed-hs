...
On a lower level, we provide locks with qed_hs_mutex_t in \refdir{lib/lock}, and
higher-level locking/threading tools in \refdir{lib/thread}, including
conditions (qed_hs_cond_t), thread-local storage (qed_hs_threadlocal_t), and more.
