...
#ifndef QED_HS_NET_TYPES_H
#define QED_HS_NET_TYPES_H
 ...
 * still work. */
#define qed_hs_socket_t intptr_t
#define QED_HS_SOCKET_T_FORMAT "%"PRIuPTR
#define SOCKET_OK(s) ((SOCKET)(s) != INVALID_SOCKET)
#define QED_HS_INVALID_SOCKET INVALID_SOCKET
#else /* !defined(_WIN32) */
/** Type used for a network socket. */
#define qed_hs_socket_t int
#define QED_HS_SOCKET_T_FORMAT "%d"
/** Macro: true iff 's' is a possible value for a valid initialized socket. */
#define SOCKET_OK(s) ((s) >= 0)
/** Error/uninitialized value for a qed_hs_socket_t. */
#define QED_HS_INVALID_SOCKET (-1)
#endif /* defined(_WIN32) */

#endif /* !defined(QED_HS_NET_TYPES_H) */
