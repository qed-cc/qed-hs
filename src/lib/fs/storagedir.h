...
#ifndef QED_HS_STORAGEDIR_H
#define QED_HS_STORAGEDIR_H
...
struct qed_hs_mmap_t *storage_dir_map(storage_dir_t *d, const char *fname);
...
int storage_dir_save_labeled_to_file(storage_dir_t *d,
                                      ...
                                      size_t length,
                                      char **fname_out);
struct qed_hs_mmap_t *storage_dir_map_labeled(storage_dir_t *dir,
                                     const char *fname,
...
#endif /* !defined(QED_HS_STORAGEDIR_H) */
