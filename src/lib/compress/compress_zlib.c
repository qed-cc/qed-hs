...
static size_t qed_hs_zlib_state_size_precalc(int inflate,
...
int
qed_hs_zlib_method_supported(void)
{
 ...
 * version of zlib. */
const char *
qed_hs_zlib_get_version_str(void)
{
  return zlibVersion();
}
...
* used at compilation. */
const char *
qed_hs_zlib_get_header_version_str(void)
{
  return ZLIB_VERSION;
}
...
struct qed_hs_zlib_compress_state_t {
...
static size_t
qed_hs_zlib_state_size_precalc(int inflate_, int windowbits, int memlevel)
{
  windowbits &= 15;
...
#define A_FEW_KILOBYTES 2048
  ...
  if (inflate_) {
    /* From zconf.h:
       ...
       for small objects."
    */
    return sizeof(qed_hs_zlib_compress_state_t) + sizeof(struct z_stream_s) +
...
/** Construct and return a qed_hs_zlib_compress_state_t object using
 * <b>method</b>. If <b>compress</b>, it's for compression; otherwise it's for
 * decompression. */
qed_hs_zlib_compress_state_t *
qed_hs_zlib_compress_new(int compress_,
                      compress_method_t method,
                      compression_level_t compression_level)
{
  qed_hs_zlib_compress_state_t *out;
  int bits, memlevel;
  ...
  out = qed_hs_malloc_zero(sizeof(qed_hs_zlib_compress_state_t));
  ...
  out->allocation = qed_hs_zlib_state_size_precalc(!compress_, bits, memlevel);
...
void
qed_hs_zlib_compress_free_(qed_hs_zlib_compress_state_t *state)
{
  if (state == NULL)
    return;
...
size_t
qed_hs_zlib_compress_state_size(const qed_hs_zlib_compress_state_t *state)
{
  qed_hs_assert(state != NULL);
...
size_t
qed_hs_zlib_get_total_allocation(void)
{
