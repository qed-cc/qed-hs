...
second-granularity and qed_hs_gettimeofday() with microsecond
...
qed_hs_localtime_r() and qed_hs_gmtime_r() to wrap these in a safe way. We
also have a qed_hs_timegm() function.
