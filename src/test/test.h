...
#ifndef QED_HS_TEST_H
#define QED_HS_TEST_H
...
#define test_mem_op_hex(expr1, op, hex)                                 \
  ...
  mem_op_hex_tmp = qed_hs_malloc(length/2);                                \
  qed_hs_assert((length&1)==0);                                            \
...
extern struct testcase_t hs_nqed_hs_tests[];
...
extern struct testcase_t nqed_hs_v3_tests[];
