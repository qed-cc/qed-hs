...
new_dir_conn(void)
{
  ...
  qed_hs_addr_from_ipv4h(&conn->base_.addr, 0x7f000001);
  TO_CONN(conn)->address = qed_hs_strdup("127.0.0.1");
  return conn;
}
...
test_dir_handle_get_v1_command_not_found(void *data)
{
  ...
  /* V1 path */
  tt_int_op(directory_handle_command_get(conn, GET("/qed-hs/"), NULL, 0),
            OP_EQ, 0);
...
test_dir_handle_get_robots_txt(void *data)
{
  ...
  tt_int_op(directory_handle_command_get(conn, GET("/qed-hs/robots.txt"),
                                         NULL, 0), OP_EQ, 0);
  fetch_from_buf_http(TO_CONN(conn)->outbuf, &header, MAX_HEADERS_SIZE,
                      &body, &body_used, 29, 0);
...
{
  if (!mock_routerinfo) {
    mock_routerinfo = qed_hs_malloc_zero(sizeof(routerinfo_t));
  }

  return mock_routerinfo;
}

#define MICRODESC_GET(digest) GET("/qed-hs/micro/d/" digest)
static void
...
init_mock_options(void)
{
  ...
  mock_options->DataDirectory = qed_hs_strdup(get_fname_rnd("datadir_tmp"));
  mock_options->CacheDirectory = qed_hs_strdup(mock_options->DataDirectory);
...
test_dir_handle_get_micro_d(void *data)
{
  ...
  qed_hs_snprintf(path, sizeof(path), MICRODESC_GET("%s"), digest_base64);
...
#define BRIDGES_PATH "/qed-hs/networkstatus-bridges"
static void
test_dir_handle_get_networkstatus_bridges_not_found_without_auth(void *data)
{
  ...
  mock_options->BridgePassword_AuthDigest_ = qed_hs_strdup("digest");
...
test_dir_handle_get_networkstatus_bridges(void *data)
{
  ...
  init_mock_options();
  mock_options->BridgeAuthoritativeDir = 1;
  mock_options->BridgePassword_AuthDigest_ = qed_hs_malloc(DIGEST256_LEN);
...
#define SERVER_DESC_GET(id) GET("/qed-hs/server/" id)
static void
...
test_dir_handle_get_server_descriptors_fp(void* data)
{
  ...
  char req[155];
  qed_hs_snprintf(req, sizeof(req), SERVER_DESC_GET("fp/%s+" HEX1 "+" HEX2),
               hex_digest);
  tt_int_op(directory_handle_command_get(conn, req, NULL, 0), OP_EQ, 0);
...
test_dir_handle_get_server_descriptors_d(void* data)
{
  ...
  qed_hs_snprintf(req_header, sizeof(req_header),
...
test_dir_handle_get_server_keys_bad_req(void* data)
{
  ...
  const char *req = GET("/qed-hs/keys/");
  tt_int_op(directory_handle_command_get(conn, req, NULL, 0), OP_EQ, 0);
...
test_dir_handle_get_server_keys_all_not_found(void* data)
{
  ...
  const char *req = GET("/qed-hs/keys/all");
  tt_int_op(directory_handle_command_get(conn, req, NULL, 0), OP_EQ, 0);
...
test_dir_handle_get_server_keys_authority_not_found(void* data)
{
  ...
  const char *req = GET("/qed-hs/keys/authority");
  tt_int_op(directory_handle_command_get(conn, req, NULL, 0), OP_EQ, 0);
...
test_dir_handle_get_server_keys_fp_not_found(void* data)
{
  ...
  const char *req = GET("/qed-hs/keys/fp/somehex");
  tt_int_op(directory_handle_command_get(conn, req, NULL, 0), OP_EQ, 0);
...
test_dir_handle_get_server_keys_fp(void* data)
{
  ...
  conn = new_dir_conn();
  char req[71];
  qed_hs_snprintf(req, sizeof(req),
                     GET("/qed-hs/keys/fp/%s"), TEST_CERT_IDENT_KEY);
  tt_int_op(directory_handle_command_get(conn, req, NULL, 0), OP_EQ, 0);
...
test_dir_handle_get_server_keys_sk_not_found(void* data)
{
  ...
  const char *req = GET("/qed-hs/keys/sk/somehex");
  tt_int_op(directory_handle_command_get(conn, req, NULL, 0), OP_EQ, 0);
...
test_dir_handle_get_server_keys_sk(void* data)
{
  ...
  char req[71];
  qed_hs_snprintf(req, sizeof(req),
               GET("/qed-hs/keys/sk/%s"), TEST_SIGNING_KEY);
  tt_int_op(directory_handle_command_get(conn, req, NULL, 0), OP_EQ, 0);
...
test_dir_handle_get_server_keys_fpsk_not_found(void* data)
{
  ...
  const char *req = GET("/qed-hs/keys/fp-sk/somehex");
  tt_int_op(directory_handle_command_get(conn, req, NULL, 0), OP_EQ, 0);
...
test_dir_handle_get_server_keys_busy(void* data)
{
  ...
  conn = new_dir_conn();
  char req[71];
  qed_hs_snprintf(req, sizeof(req), GET("/qed-hs/keys/fp/%s"), TEST_CERT_IDENT_KEY);
  tt_int_op(directory_handle_command_get(conn, req, NULL, 0), OP_EQ, 0);
...
test_dir_handle_get_status_vote_current_consensus_ns_not_enough_sigs(void* d)
{
  ...
  /* init mock */
  mock_ns_val = qed_hs_malloc_zero(sizeof(networkstatus_t));
  ...
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/current/consensus-ns/" HEX1 "+" HEX2), NULL, 0));
...
test_dir_handle_get_status_vote_current_consensus_ns_not_found(void* data)
{
  ...
  conn = new_dir_conn();
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/current/consensus-ns"), NULL, 0));
...
test_dir_handle_get_status_vote_current_consensus_too_old(void *data)
{
  ...
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/current/consensus-microdesc"), NULL, 0));
  ...
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/current/consensus"), NULL, 0));
...
static int dhg_tests_geoip_get_country_by_addr(const qed_hs_addr_t *addr);
ATTR_UNUSED static int dhg_tests_geoip_get_country_by_addr_called = 0;

int
dhg_tests_geoip_get_country_by_addr(const qed_hs_addr_t *addr)
{
  (void)addr;
                                      ...
                                      size_t *body_len)
{
  ...
  dirserv_set_cached_consensus_networkstatus(NETWORK_STATUS, "ns", &digests,
                                             ...
                                             time(NULL));
#endif /* 0 */
  networkstatus_t *ns = qed_hs_malloc_zero(sizeof(networkstatus_t));
...
test_dir_handle_get_status_vote_current_consensus_ns(void* data)
{
  ...
  qed_hs_uncompress(&body, &body_used, comp_body, comp_body_used,
...
test_dir_handle_get_status_vote_current_not_found(void* data)
{
  ...
  conn = new_dir_conn();
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/current/" HEX1), NULL, 0));
...
status_vote_current_d_test(char **header, char **body, size_t *body_l)
{
  ...
  conn = new_dir_conn();
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/current/d/" VOTE_DIGEST), NULL, 0));
...
status_vote_next_d_test(char **header, char **body, size_t *body_l)
{
  ...
  conn = new_dir_conn();
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/next/d/" VOTE_DIGEST), NULL, 0));
...
test_dir_handle_get_status_vote_next_not_found(void* data)
{
  ...
  conn = new_dir_conn();
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/next/" HEX1), NULL, 0));
...
status_vote_next_consensus_test(char **header, char **body, size_t *body_used)
{
  ...
  conn = new_dir_conn();
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/next/consensus"), NULL, 0));
...
test_dir_handle_get_status_vote_current_authority_not_found(void* data)
{
  ...
  conn = new_dir_conn();
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/current/authority"), NULL, 0));
...
test_dir_handle_get_status_vote_next_authority_not_found(void* data)
{
  ...
  conn = new_dir_conn();
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/next/authority"), NULL, 0));
...
test_dir_handle_get_status_vote_next_bandwidth_not_found(void* data)
{
  ...
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/next/bandwidth"), NULL, 0));
                                           ...
                                           size_t *body_used)
{
  ...
  conn = new_dir_conn();
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/next/consensus-signatures"), NULL, 0));
...
test_dir_handle_get_status_vote_next_bandwidth(void* data)
{
  ...
  init_mock_options();
  MOCK(get_options, mock_get_options);
  mock_options->V3BandwidthsFile = qed_hs_strdup(
  ...
  qed_hs_asprintf(&expires, "Expires: %s\r\n", expbuf);
  ...
  tt_int_op(0, OP_EQ, directory_handle_command_get(conn,
    GET("/qed-hs/status-vote/next/bandwidth.z"), NULL, 0));
