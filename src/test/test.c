...
test_onion_queues(void *arg)
{
  ...
  create_cell_t *create1 = qed_hs_malloc_zero(sizeof(create_cell_t));
  create_cell_t *create2 = qed_hs_malloc_zero(sizeof(create_cell_t));
  (void)arg;
...
test_onion_queue_order(void *arg)
{
  ...
  create_cell_t *create_ntor1 = qed_hs_malloc_zero(sizeof(create_cell_t));
  create_cell_t *create_ntor2 = qed_hs_malloc_zero(sizeof(create_cell_t));
  create_cell_t *create_v3ntor1 = qed_hs_malloc_zero(sizeof(create_cell_t));
  create_cell_t *create_v3ntor2 = qed_hs_malloc_zero(sizeof(create_cell_t));
  (void)arg;
  ...
  qed_hs_free(create_ntor1);
  qed_hs_free(create_ntor2);
  qed_hs_free(create_v3ntor1);
  qed_hs_free(create_v3ntor2);
}
    ...
    int32_t min_val, int32_t max_val)
{
  ...
  qed_hs_assert(strcmp(param_name, "cbtnummodes")==0);
  return cbtnummodes;
}
