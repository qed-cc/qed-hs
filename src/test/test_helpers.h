...
#ifndef QED_HS_TEST_HELPERS_H
#define QED_HS_TEST_HELPERS_H
...
int mock_qed_hs_addr_lookup__fail_on_bad_addrs(const char *name,
...
#endif /* !defined(QED_HS_TEST_HELPERS_H) */
