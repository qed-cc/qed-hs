                          ...
                          consensus_digest_t *digest_out)
{
  ...
  char *tmp = qed_hs_memdup(cons, len);
...
test_consdiff_lcs_lengths(void *arg)
{
  ...
  qed_hs_free(lengths1);
  qed_hs_free(lengths2);
  qed_hs_free(sls1);
  qed_hs_free(sls2);
  smartlist_free(sl1);
  smartlist_free(sl2);
