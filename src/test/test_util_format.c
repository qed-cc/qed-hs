...
test_util_format_unaligned_accessors(void *ignored)
{
  ...
  tt_u64_op(get_uint64(buf+1), OP_EQ,
      qed_hs_htonll(UINT64_C(0x6e696f6e736f7570)));
  ...
  set_uint64(buf+1, qed_hs_htonll(UINT64_C(0x6266757363617465)));
...
test_util_format_base64_encode(void *ignored)
{
  ...
  src = qed_hs_malloc_zero(256);
  dst = qed_hs_malloc_zero(1000);
...
test_util_format_base64_decode(void *ignored)
{
  ...
  src = qed_hs_malloc_zero(256);
  dst = qed_hs_malloc_zero(1000);
  real_dst = qed_hs_malloc_zero(10);
...
test_util_format_base32_encode(void *arg)
{
  ...
  char *dst = qed_hs_malloc_zero(real_dstlen);
