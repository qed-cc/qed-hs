...
test_status_count_circuits(void *arg)
{
  ...
  mock_circuit1 = qed_hs_malloc_zero(sizeof(origin_circuit_t));
  mock_circuit2 = qed_hs_malloc_zero(sizeof(origin_circuit_t));
  ...
  qed_hs_free(mock_circuit1);
  qed_hs_free(mock_circuit2);
...
{
  mock_routerinfo = qed_hs_malloc(sizeof(routerinfo_t));
...
test_status_hb_calls_log_accounting(void *arg)
{
  ...
  tt_int_op(mock_saved_log_n_entries(), OP_EQ, 2);
    ...
    qed_hs_free_(status_hb_calls_log_accounting_mock_state);
    qed_hs_free_(status_hb_calls_log_accounting_mock_options);
}
...
status_hb_calls_log_accounting_get_or_state(void)
{
  status_hb_calls_log_accounting_mock_state =
    qed_hs_malloc_zero(sizeof(or_state_t));
  status_hb_calls_log_accounting_mock_state
