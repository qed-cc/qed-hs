...
test_contains(void *arg)
{
  ...
  qed_hs_addr_t addr_v6;
  qed_hs_addr_parse(&addr_v6, "1:2:3:4::");
  qed_hs_addr_t addr_v4;
  qed_hs_addr_parse(&addr_v4, "42.42.42.42");
  uint32_t ipv4h = qed_hs_addr_to_ipv4h(&addr_v4);
...
test_nodelist(void *arg)
{
  ...
  qed_hs_addr_t addr_v4, addr_v6, dummy_addr;
  qed_hs_addr_parse(&addr_v4, "42.42.42.42");
  qed_hs_addr_parse(&addr_v6, "1:2:3:4::");
  memset(&dummy_addr, 'A', sizeof(dummy_addr));
  ...
  qed_hs_addr_parse(&rs->ipv6_addr, "1:2:3:4::");
  qed_hs_addr_copy(&ri->ipv4_addr, &addr_v4);
  qed_hs_addr_parse(&ri->ipv6_addr, "1:2:3:4::");
  qed_hs_addr_parse(&md->ipv6_addr, "1:2:3:4::");
