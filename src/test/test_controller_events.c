...
{
  testing_cell_stats_entry_t *ent = qed_hs_malloc_zero(
...
test_cntev_format_cell_stats(void *arg)
{
  ...
  ocirc = qed_hs_malloc_zero(sizeof(origin_circuit_t));
  ...
  p_chan = qed_hs_malloc_zero(sizeof(channel_tls_t));
...
test_cntev_format_stream(void *arg)
{
  ...
  char *username = qed_hs_strdup("jeremy");
  char *password = qed_hs_strdup("letmein");
