...
test_build_address(void *arg)
{
  ...
  qed_hs_asprintf(&service->config.directory_path, "/double/five");
...
helper_add_hsdir_to_networkstatus(networkstatus_t *ns,
                                  ...
                                  int is_hsdir)
{
  routerstatus_t *rs = qed_hs_malloc_zero(sizeof(routerstatus_t));
  ...
  qed_hs_addr_parse(&ri->ipv4_addr, "1.2.3.4");
  qed_hs_addr_parse(&rs->ipv4_addr, "1.2.3.4");
  ri->nickname = qed_hs_strdup(nickname);
  ri->protocol_list = qed_hs_strdup("HSDir=1-2 LinkAuth=3");
   ...
   * true. */
  node->md = qed_hs_malloc_zero(sizeof(microdesc_t));
...
mock_networkstatus_get_latest_consensus(void)
{
  ...
  mock_ns = qed_hs_malloc_zero(sizeof(networkstatus_t));
...
test_hid_serv_request_tracker(void *arg)
{
 ...
 "g53o7iavcd62oihswhr24u6czmqws5kpXnw4526ThUNbL5o1go+EdUuEqlKxHkNbnK41pRzizzs";
  ...
  hsdir = qed_hs_malloc_zero(sizeof(routerstatus_t));
  ...
  hsdir2 = qed_hs_malloc_zero(sizeof(routerstatus_t));
  ...
  hsdir3 = qed_hs_malloc_zero(sizeof(routerstatus_t));
                                                         ...
                                                         int flavor)
{
  ...
  mock_service_ns = qed_hs_malloc_zero(sizeof(networkstatus_t));
...
mock_networkstatus_get_reasonably_live_consensus_client(time_t now, int flavor)
{
  ...
  mock_client_ns = qed_hs_malloc_zero(sizeof(networkstatus_t));
...
are_responsible_hsdirs_equal(void)
{
  ...
  SMARTLIST_FOREACH_BEGIN(client_responsible_hsdirs,
    ...
    SMARTLIST_FOREACH_BEGIN(service_responsible_hsdirs,
      ...
      if (qed_hs_memeq(c_rs->identity_digest, s_rs->identity_digest,
                    DIGEST_LEN)) {
        count++;
        break;
      }
...
run_reachability_scenario(const reachability_cfg_t *cfg, int num_scenario)
{
  ...
  if (ret == -1) {
    ...
    char msg[32];
    qed_hs_snprintf(msg, sizeof(msg), "Scenario %d failed", num_scenario);
    tt_fail_msg(msg);
  }
  return ret;
}
