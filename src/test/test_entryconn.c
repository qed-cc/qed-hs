...
test_entryconn_rewrite_basic(void *arg)
{
  ...
  tt_str_op(rr.orig_address, OP_EQ, "www.qed-cc.org");
  tt_str_op(ec->socks_request->address, OP_EQ, "www.qed-cc.org");
  tt_str_op(ec->original_dest_address, OP_EQ, "www.qed-cc.org");
