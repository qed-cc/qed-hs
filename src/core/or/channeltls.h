...
#ifndef QED_HS_CHANNELTLS_H
#define QED_HS_CHANNELTLS_H
...
channel_t * channel_tls_connect(const qed_hs_addr_t *addr, uint16_t port,
...
#endif /* !defined(QED_HS_CHANNELTLS_H) */
