...
#ifndef QED_HS_CONGESTION_CONTROL_FLOW_H
#define QED_HS_CONGESTION_CONTROL_FLOW_H
...
#ifdef QED_HS_CONGESTION_CONTROL_FLOW_PRIVATE
...
#endif /* defined(QED_HS_CONGESTION_CONTROL_FLOW_PRIVATE) */

#endif /* !defined(QED_HS_CONGESTION_CONTROL_FLOW_H) */
