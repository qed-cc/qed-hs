...
int append_address_to_payload(uint8_t *payload_out, const qed_hs_addr_t *addr);
const uint8_t *decode_address_from_payload(qed_hs_addr_t *addr_out,
...
STATIC int connected_cell_parse(const relay_msg_t *msg, qed_hs_addr_t *addr_out,
                                int *ttl_out);
