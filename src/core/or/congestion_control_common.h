...
#ifndef QED_HS_CONGESTION_CONTROL_COMMON_H
#define QED_HS_CONGESTION_CONTROL_COMMON_H
...
#ifdef QED_HS_CONGESTION_CONTROL_COMMON_PRIVATE
...
#endif /* defined(QED_HS_CONGESTION_CONTROL_PRIVATE) */

#endif /* !defined(QED_HS_CONGESTION_CONTROL_COMMON_H) */
