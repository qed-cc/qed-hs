...
#ifndef QED_HS_POLICIES_H
#define QED_HS_POLICIES_H
...
int reachable_addr_allows_addr(const qed_hs_addr_t *addr,
                                         uint16_t port,
...
int dir_policy_permits_address(const qed_hs_addr_t *addr);
int socks_policy_permits_address(const qed_hs_addr_t *addr);
int metrics_policy_permits_address(const qed_hs_addr_t *addr);
int authdir_policy_permits_address(const qed_hs_addr_t *addr, uint16_t port);
int authdir_policy_valid_address(const qed_hs_addr_t *addr, uint16_t port);
int authdir_policy_badexit_address(const qed_hs_addr_t *addr, uint16_t port);
int authdir_policy_middleonly_address(const qed_hs_addr_t *addr, uint16_t port);
...
MOCK_DECL(addr_policy_result_t, compare_qed_hs_addr_to_addr_policy,
    (const qed_hs_addr_t *addr, uint16_t port, const smartlist_t *policy));
addr_policy_result_t compare_qed_hs_addr_to_node_policy(const qed_hs_addr_t *addr,
...
addr_policy_result_t compare_qed_hs_addr_to_short_policy(
...
STATIC int reachable_addr_allows(const qed_hs_addr_t *addr,
                                           uint16_t port,
                                           smartlist_t *firewall_policy,
                                           int pref_only, int pref_ipv6);
STATIC const qed_hs_addr_port_t * reachable_addr_choose(
                                          const qed_hs_addr_port_t *a,
...
#endif /* !defined(QED_HS_POLICIES_H) */
