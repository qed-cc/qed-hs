...
typedef enum {
  ...
  /**
   * Prop#324 QED_HS_WESTWOOD - Deliberately aggressive. Westwood may not even
  ...
  /**
   * Prop#324 QED_HS_VEGAS - TCP Vegas-style BDP tracker. Because Vegas backs off
  ...
  /**
   * Prop#324: QED_HS_NOLA - NOLA looks the BDP right in the eye and uses it
   * immediately as CWND. No slow start, no other congestion signals, no delay,
   * no bullshit. Like QED_HS_VEGAS, it also uses aggressive BDP estimates, to
