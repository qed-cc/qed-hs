...
#ifndef QED_HS_HS_NQED_HS_H
#define QED_HS_HS_NQED_HS_H
...
} hs_nqed_hs_intro_cell_keys_t;

/* Key material needed to encode/decode RENDEZVOUS1 cells */
typedef struct hs_nqed_hs_rend_cell_keys_t {
...
int hs_nqed_hs_client_get_introduce1_keys(
...
int hs_nqed_hs_client_get_rendezvous1_keys(
          const struct ed25519_public_key_t *intro_auth_pubkey,
          const struct curve25519_keypair_t *client_ephemeral_enc_keypair,
          const struct curve25519_public_key_t *intro_enc_pubkey,
...
int hs_nqed_hs_service_get_introduce1_keys_multi(
            const struct ed25519_public_key_t *intro_auth_pubkey,
...
int hs_nqed_hs_service_get_introduce1_keys(
            const struct ed25519_public_key_t *intro_auth_pubkey,
            const struct curve25519_keypair_t *intro_enc_keypair,
            const struct curve25519_public_key_t *client_ephemeral_enc_pubkey,
            const hs_subcredential_t *subcredential,
...
int hs_nqed_hs_service_get_rendezvous1_keys(
            const struct ed25519_public_key_t *intro_auth_pubkey,
            const struct curve25519_keypair_t *intro_enc_keypair,
...
int hs_nqed_hs_circuit_key_expansion(const uint8_t *nqed_hs_key_seed,
                                  size_t seed_len,
                                  uint8_t *keys_out, size_t keys_out_len);

int hs_nqed_hs_client_rendezvous2_mac_is_good(
                        const hs_nqed_hs_rend_cell_keys_t *hs_nqed_hs_rend_cell_keys,
                        const uint8_t *rcvd_mac);

#endif /* !defined(QED_HS_HS_NQED_HS_H) */
