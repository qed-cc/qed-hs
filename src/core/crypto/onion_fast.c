                      ...
                      uint8_t *handshake_out)
{
  ...
  *handshake_state_out = s = qed_hs_malloc(sizeof(fast_handshake_state_t));
                      ...
                      const char **msg_out)
{
  ...
  if (qed_hs_memneq(out, handshake_reply_out+DIGEST_LEN, DIGEST_LEN)) {
