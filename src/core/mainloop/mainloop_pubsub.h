...
#ifndef QED_HS_MAINLOOP_PUBSUB_H
#define QED_HS_MAINLOOP_PUBSUB_H
...
int qed_hs_mainloop_connect_pubsub(struct pubsub_builder_t *builder);
void qed_hs_mainloop_connect_pubsub_events(void);
int qed_hs_mainloop_set_delivery_strategy(const char *msg_channel_name,
                                        deliv_strategy_t strategy);
void qed_hs_mainloop_disconnect_pubsub(void);

#endif /* !defined(QED_HS_MAINLOOP_PUBSUB_H) */
