...
void qed_hs_shutdown_event_loop_and_exit(int exitcode);
int qed_hs_event_loop_shutdown_is_pending(void);
...
void qed_hs_init_connection_lists(void);
void initialize_mainloop_events(void);
void initialize_periodic_events(void);
void qed_hs_mainloop_free_all(void);
...
#endif /* !defined(QED_HS_MAINLOOP_H) */
