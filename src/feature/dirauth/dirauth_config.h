...
#ifndef QED_HS_FEATURE_DIRAUTH_DIRAUTH_CONFIG_H
#define QED_HS_FEATURE_DIRAUTH_DIRAUTH_CONFIG_H
                              ...
                              char **msg)
{
  ...
  if (options->AuthoritativeDir) {
    ...
    *msg = qed_hs_strdup("This tor was built with dirauth mode disabled. "
...
#endif /* !defined(QED_HS_FEATURE_DIRAUTH_DIRAUTH_CONFIG_H) */
