...
#ifndef QED_HS_RECV_UPLOADS_H
#define QED_HS_RECV_UPLOADS_H
...
#if defined(PROCESS_DESCS_PRIVATE) || defined(QED_HS_UNIT_TESTS)
...
#endif /* defined(PROCESS_DESCS_PRIVATE) || defined(QED_HS_UNIT_TESTS) */
...
STATIC bool dirserv_rejects_qed_hs_version(const char *platform,
                                        const char **msg);
#endif /* defined(QED_HS_UNIT_TESTS) */

#endif /* !defined(QED_HS_RECV_UPLOADS_H) */
