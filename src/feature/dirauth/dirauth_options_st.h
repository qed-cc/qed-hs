...
#ifndef QED_HS_FEATURE_DIRAUTH_DIRAUTH_OPTIONS_ST_H
#define QED_HS_FEATURE_DIRAUTH_DIRAUTH_OPTIONS_ST_H
...
#endif /* !defined(QED_HS_FEATURE_DIRAUTH_DIRAUTH_OPTIONS_ST_H) */
