...
#ifndef QED_HS_NODE_SELECT_H
#define QED_HS_NODE_SELECT_H
...
STATIC const routerstatus_t *router_pick_directory_server_impl(
                                           ...
                                           int *n_busy_out);
STATIC int router_is_already_dir_fetching(const qed_hs_addr_port_t *ap,
                                          int serverdesc, int microdesc);
#endif /* defined(NODE_SELECT_PRIVATE) */

#endif /* !defined(QED_HS_NODE_SELECT_H) */
