...
#ifndef QED_HS_ROUTERSET_H
#define QED_HS_ROUTERSET_H
...
STATIC int routerset_contains(const routerset_t *set, const qed_hs_addr_t *addr,
                   uint16_t orport,
...
#endif /* !defined(QED_HS_ROUTERSET_H) */
