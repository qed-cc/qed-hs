...
#ifndef QED_HS_NETWORKSTATUS_H
#define QED_HS_NETWORKSTATUS_H
...
qed_hs_mmap_t *networkstatus_map_cached_consensus(const char *flavorname);
...
#endif /* !defined(QED_HS_NETWORKSTATUS_H) */
