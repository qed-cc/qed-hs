...
struct routerlist_t {
  ...
  /** Map from server descriptor digest to a signed_descripqed_hs_t from
  ...
  /** Map from extra-info digests to a signed_descripqed_hs_t for a router
  ...
  smartlist_t *routers;
  /** List of signed_descripqed_hs_t for older router descriptors we're
   * caching. */
