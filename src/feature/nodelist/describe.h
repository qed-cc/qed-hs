...
#ifndef QED_HS_DESCRIBE_H
#define QED_HS_DESCRIBE_H
...
#if defined(DESCRIBE_PRIVATE) || defined(QED_HS_UNIT_TESTS)
...
#endif /* defined(DESCRIBE_PRIVATE) || defined(QED_HS_UNIT_TESTS) */
...
#endif /* !defined(QED_HS_DESCRIBE_H) */
