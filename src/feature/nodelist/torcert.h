...
qed_hs_cert_t *qed_hs_cert_create_ed25519(const ed25519_keypair_t *signing_key,
                            uint8_t cert_type,
                            const ed25519_public_key_t *signed_key,
                            time_t now, time_t lifetime,
                            uint32_t flags);
qed_hs_cert_t * qed_hs_cert_create_raw(const ed25519_keypair_t *signing_key,
                      uint8_t cert_type,
...
qed_hs_cert_t *qed_hs_cert_parse(const uint8_t *cert, size_t certlen);

void qed_hs_cert_free_(qed_hs_cert_t *cert);
#define qed_hs_cert_free(cert) FREE_AND_NULL(qed_hs_cert_t, qed_hs_cert_free_, (cert))

int qed_hs_cert_get_checkable_sig(ed25519_checkable_t *checkable_out,
                               const qed_hs_cert_t *out,
                               const ed25519_public_key_t *pubkey,
                               time_t *expiration_out);

int qed_hs_cert_checksig(qed_hs_cert_t *cert,
                      const ed25519_public_key_t *pubkey, time_t now);
const char *qed_hs_cert_describe_signature_status(const qed_hs_cert_t *cert);

MOCK_DECL(qed_hs_cert_t *,qed_hs_cert_dup,(const qed_hs_cert_t *cert));
int qed_hs_cert_eq(const qed_hs_cert_t *cert1, const qed_hs_cert_t *cert2);
int qed_hs_cert_opt_eq(const qed_hs_cert_t *cert1, const qed_hs_cert_t *cert2);

ssize_t qed_hs_make_rsa_ed25519_crosscert(const ed25519_public_key_t *ed_key,
...
int qed_hs_cert_encode_ed22519(const qed_hs_cert_t *cert, char **cert_str_out);
