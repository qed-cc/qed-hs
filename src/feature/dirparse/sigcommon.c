                            ...
                            const char **start_out, const char **end_out)
{
  ...
  start = qed_hs_memstr(s, s_len, start_str);
  if (!start) {
  ...
  end = qed_hs_memstr(start+strlen(start_str),
                      ...
                      const char *doctype))
{
  ...
  signed_digest = qed_hs_malloc(keysize);
