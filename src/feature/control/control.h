...
#ifndef QED_HS_CONTROL_H
#define QED_HS_CONTROL_H
...
int control_connection_add_local_fd(qed_hs_socket_t sock, unsigned flags);
...
void moniqed_hs_owning_controller_process(const char *process_spec);
...
#endif /* !defined(QED_HS_CONTROL_H) */
