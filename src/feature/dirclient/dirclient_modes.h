...
#ifndef QED_HS_FEATURE_DIRCLIENT_DIRCLIENT_MODES_H
#define QED_HS_FEATURE_DIRCLIENT_DIRCLIENT_MODES_H
...
#endif /* !defined(QED_HS_FEATURE_DIRCLIENT_DIRCLIENT_MODES_H) */
