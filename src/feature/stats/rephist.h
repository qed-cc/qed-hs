...
#ifndef QED_HS_REPHIST_H
#define QED_HS_REPHIST_H
...
void rep_hist_note_router_reachable(const char *id, const qed_hs_addr_t *at_addr,
 ...
 * tap, fast, and ntor. The max type is nqed_hs_v3 (3) */
...
#endif /* !defined(QED_HS_REPHIST_H) */
