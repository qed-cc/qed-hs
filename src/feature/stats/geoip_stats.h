...
#ifndef QED_HS_GEOIP_STATS_H
#define QED_HS_GEOIP_STATS_H
...
void geoip_note_client_seen(geoip_client_action_t action,
                            const qed_hs_addr_t *addr, const char *transport_name,
                            time_t now);
void geoip_remove_old_clients(time_t cutoff);
clientmap_entry_t *geoip_lookup_client(const qed_hs_addr_t *addr,
...
#endif /* !defined(QED_HS_GEOIP_STATS_H) */
