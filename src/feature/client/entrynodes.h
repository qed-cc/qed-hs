...
#ifndef QED_HS_ENTRYNODES_H
#define QED_HS_ENTRYNODES_H
...
struct entry_guard_t {
  ...
  qed_hs_addr_port_t *bridge_addr;
...
void entry_guard_learned_bridge_identity(const qed_hs_addr_port_t *addrport,
...
#endif /* !defined(QED_HS_ENTRYNODES_H) */
