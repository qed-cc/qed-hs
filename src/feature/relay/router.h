...
#ifndef QED_HS_ROUTER_H
#define QED_HS_ROUTER_H
...
#define QED_HS_ROUTERINFO_ERROR_NO_EXT_ADDR     (-1)
#define QED_HS_ROUTERINFO_ERROR_CANNOT_PARSE    (-2)
#define QED_HS_ROUTERINFO_ERROR_NOT_A_SERVER    (-3)
#define QED_HS_ROUTERINFO_ERROR_DIGEST_FAILED   (-4)
#define QED_HS_ROUTERINFO_ERROR_CANNOT_GENERATE (-5)
#define QED_HS_ROUTERINFO_ERROR_DESC_REBUILDING (-6)
#define QED_HS_ROUTERINFO_ERROR_INTERNAL_BUG    (-7)
...
#else
#define get_server_identity_key() (qed_hs_abort_(),NULL)
#endif
...
void routerconf_find_ipv6_or_ap(const or_options_t *options,
                                      qed_hs_addr_port_t *ipv6_ap_out);
...
bool router_addr_is_my_published_addr(const qed_hs_addr_t *addr);
...
void log_addr_has_changed(int severity, const qed_hs_addr_t *prev,
                          const qed_hs_addr_t *cur, const char *source);
