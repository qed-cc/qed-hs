...
#ifndef QED_HS_FEATURE_RELAY_TRANSPORT_CONFIG_H
#define QED_HS_FEATURE_RELAY_TRANSPORT_CONFIG_H
                                  ...
                                  char **msg)
{
  ...
  if (options->ServerTransportPlugin ||
    ...
    *msg = qed_hs_strdup("This tor was built with relay mode disabled. "
...
#endif /* !defined(QED_HS_FEATURE_RELAY_TRANSPORT_CONFIG_H) */
