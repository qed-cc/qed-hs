...
#ifndef QED_HS_FEATURE_RELAY_CIRCUITBUILD_RELAY_H
#define QED_HS_FEATURE_RELAY_CIRCUITBUILD_RELAY_H
...
STATIC const qed_hs_addr_port_t * circuit_choose_ip_ap_for_extend(
                                             const qed_hs_addr_port_t *ipv4_ap,
...
#endif /* !defined(QED_HS_FEATURE_RELAY_CIRCUITBUILD_RELAY_H) */
