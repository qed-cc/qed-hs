...
#ifndef QED_HS_RELAY_FIND_ADDR_H
#define QED_HS_RELAY_FIND_ADDR_H
...
void relay_address_new_suggestion(const qed_hs_addr_t *suggested_addr,
...
#endif /* !defined(QED_HS_RELAY_FIND_ADDR_H) */
