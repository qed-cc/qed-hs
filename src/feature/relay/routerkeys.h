...
#ifndef QED_HS_ROUTERKEYS_H
#define QED_HS_ROUTERKEYS_H
...
MOCK_DECL(const struct qed_hs_cert_st *, get_master_signing_key_cert,(void));

const ed25519_keypair_t *get_current_auth_keypair(void);
const struct qed_hs_cert_st *get_current_link_cert_cert(void);
const struct qed_hs_cert_st *get_current_auth_key_cert(void);
...
#define get_current_link_cert_cert() \
  relay_key_is_unavailable(const struct qed_hs_cert_st *)
...
#endif /* !defined(QED_HS_ROUTERKEYS_H) */
