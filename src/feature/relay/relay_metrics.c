...
fill_cc_gauges_values(void)
{
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_exit_ss_cwnd_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_exit_ss_bdp_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_exit_ss_inc_ma));
  ...
  metrics_store_entry_add_label(sentry,
          metrics_format_label("action", "cwnd"));
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_circ_close_cwnd_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_circ_close_ss_cwnd_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_flow_xon_outbuf_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_flow_xoff_outbuf_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_csig_blocked_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_gamma_drop_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_delta_drop_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_ss_csig_blocked_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_csig_alpha_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_csig_beta_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_csig_delta_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_ss_queue_ma));
  ...
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_queue_ma));
  ...
  metrics_store_entry_add_label(sentry,
          metrics_format_label("action", "bdp"));
  metrics_store_entry_update(sentry,
                             qed_hs_llround(cc_stats_vegas_bdp_ma));
}
...
fill_dns_error_values(void)
{
  ...
  static struct dns_error {
    ...
    { .name = "qed_hs_timeout",  .key = DNS_ERR_TIMEOUT      },
  ...
  for (size_t i = 0; i < num_dns_types; i++) {
    ...
    char *record_label =
      qed_hs_strdup(metrics_format_label("record", dns_types[i].name));
...
fill_onionskins_values(void)
{
  ...
  for (uint16_t t = 0; t <= MAX_ONION_HANDSHAKE_TYPE; t++) {
     ...
     * string on the stack and we need that label for all metrics. */
    char *type_label =
      qed_hs_strdup(metrics_format_label("type", handshake_type_to_str(t)));
    sentry = metrics_store_add(the_store, rentry->type, rentry->name,
                               rentry->help, 0, NULL);
