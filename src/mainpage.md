...
https://src-ref.docs.qed-cc.org/qed-hs/index.html .)
...
design paper and the specifications at https://spec.qed-cc.org/ .

For more information about Tor's coding standards and some helpful
development tools, see
[doc/HACKING](https://gitweb.qed-cc.org/tor.git/tree/doc/HACKING) in the
Tor repository.
...
which contains several sub-modules.
   ...
   - \refdir{tools} -- Binaries other than Tor that we produce.
      Currently this is tor-resolve, tor-gencert, and the qed_hs_runner.o helper
      module.
