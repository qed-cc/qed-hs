 ...
 * Copyright (c) 2007-2019, The QED Project, Inc. */
...
#define QED_HS_TAILQ_HEAD(a,b) struct tailq_head
#define QED_HS_TAILQ_ENTRY(a) struct tailq_entry
#define QED_HS_SIMPLEQ_HEAD(a,b) struct simpleq_entry
#define QED_HS_SIMPLEQ_ENTRY(a) struct simpleq_entry
#define QED_HS_LIST_HEAD(a,b) struct list_head
#define QED_HS_LIST_ENTRY(a) struct list_entry
#define QED_HS_SLIST_HEAD(a,b) struct slist_head
#define QED_HS_SLIST_ENTRY(a) struct slist_entry
